...
House price prediction.ipynb file contains first question (Predict the price of a house).
Description:
...
Amazon and Flipkart product matching contains second question (Product matching)
Description:
